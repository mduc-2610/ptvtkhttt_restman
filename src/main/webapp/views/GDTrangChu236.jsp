        ...
        <div class="dashboard">
            <div class="feature-grid">
                <div class="feature-card">
                    ...
                    <a href="/RestMan/views/monan/GDTimKiemMonAn236.jsp" class="btn-primary feature-card-button">Tìm kiếm</a>
                </div>
                <div class="feature-card">
                    ...
                    <a href="/RestMan/views/baocao/GDBaoCao236.jsp" class="btn-primary feature-card-button">Báo cáo</a>
                </div>
            </div>
        </div>
    </div>
